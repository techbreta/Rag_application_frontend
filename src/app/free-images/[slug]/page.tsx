...
export async function generateMetadata({
  ...
  const pageUrl = `${BASE_URL}/free-images/${params.slug}`;
...
export default async function ImageDetailPage({
  ...
  const imageObjectSchema = {
    ...
    description: `Royalty-free high-resolution AI generated image: "${image.prompt}"`,
    datePublished: image.createdAt,
    author: {
      "@type": "Organization",
      name: "RagAI Latent Diffusion Studio",
      url: BASE_URL,
    },
    license: "https://creativecommons.org/publicdomain/zero/1.0/",
    acquireLicensePage: pageUrl,
    creditText: "Generated by RagAI",
    creator: {
      "@type": "Organization",
      name: "RagAI",
    },
    copyrightNotice: "Public Domain / CC0 Commercial Usage",
  };
