...
export const metadata: Metadata = {
  ...
  description: "Learn how RAG AI works in 4 simple steps: upload documents, choose chat mode, ask questions, and get smart answers with source citations.",
  keywords: "RAG, how it works, document processing, AI Q&A, document chat, retrieval augmented generation",
  openGraph: {
    title: "How It Works | RAG AI",
    description: "Discover RAG AI's simple 4-step process for intelligent document Q&A",
