...
export default function AdminUsersPage() {
  ...
  const [activeUserTab, setActiveUserTab] = useState<"info" | "docs" | "chats" | "images">("info");
            ...
            {activeUserTab === "images" && (
              <div className="space-y-2">
                {selectedUser.images?.length === 0 ? (
                  <p className="py-6 text-center text-xs text-slate-500">
                    No images generated by this user yet.
                  </p>
                ) : (
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                    {selectedUser.images.map((img: any) => (
                      <div
                        key={img._id}
                        className="rounded-xl border border-slate-800 bg-slate-950/40 overflow-hidden flex flex-col justify-between group"
                      >
                        ...
                        <div className="p-2 space-y-1">
                          <p className="text-[11px] font-medium text-slate-200 line-clamp-1" title={img.prompt}>
                            {img.prompt}
                          </p>
                          <a
